...
<template>
  <div class="relative">
    ...
    <button
      ...
      type="button"
      :title="showPassword ? t('common.actions.hidePassword') : t('common.actions.hidePassword')"
      :aria-label="
        showPassword ? t('common.actions.hidePassword') : t('common.actions.hidePassword')
      "
