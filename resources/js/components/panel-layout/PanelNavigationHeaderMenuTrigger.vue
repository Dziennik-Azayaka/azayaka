...
<template>
  ...
  >
    <div class="flex-1 overflow-hidden">
      ...
      <p class="text-xs text-muted-foreground text-ellipsis overflow-hidden text-nowrap">
        {{ userStore.access?.name ?? userStore.user?.email }}
      </p>
    </div>
    <LucideChevronsUpDown
      aria-label="Przejdź do innego modułu"
      title="Przejdź do innego modułu"
      class="size-4"
    />
  </button>
</template>
