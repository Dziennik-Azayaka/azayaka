...
import { editStudentFormSchema, type EditStudentFormValues } from '../../forms/editStudent';
...
const props = defineProps<{
  isPending: boolean;
  initialValues?: Partial<EditStudentFormValues>;
  error: Error | null;
}>();
const emit = defineEmits<{ submit: [EditStudentFormValues] }>();

const { t } = useI18n();

const form = useForm({
  validationSchema: editStudentFormSchema,
