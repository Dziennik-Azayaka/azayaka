...
<template>
    <div
        role="alert"
        class="px-6 py-5 flex not-sm:flex-col justify-between items-center gap-3 bg-foreground dark:bg-accent text-background dark:text-foreground rounded-lg"
    >
        <p class="text-sm font-medium">
            {{ t("activationBannerText") }}
        </p>
        <Button
            size="sm"
            variant="outline"
